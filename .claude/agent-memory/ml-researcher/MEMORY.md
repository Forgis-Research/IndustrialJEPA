...
- [IndustrialJEPA Project Context](project_industrialjepa.md) — V15 DONE: bidi EMA collapses (shared prefix bug), SIGReg pending, SMAP needs 100+ epochs, V16=bidir context+causal target
