...
FD001 at 5%/2%/1% labels; FD003 at 5%/2%/1% labels; 3 seeds each.
...
| FD003 | 0.853 ± 0.004 | 0.830 ± 0.018 | 0.709 ± 0.131 | 0.635 ± 0.065 | 0.513 ± 0.220 | high var at 1 engine; s42=0.292 unlucky engine |
...
3. **FD003 degrades faster**: At 5%, 0.709 ± 0.131 (83% retention). At 2%, 0.635 ± 0.065 (74%). At 1%, 0.513 ± 0.220 (60%) - collapses near chance when unlucky single engine selected. FD003's multi-fault degradation modes require more engines to represent all fault types.
4. **FD003 lf1 per-seed**: s42=0.292 (near chance - bad single engine), s123=0.731, s456=0.515. Mean 0.513 is heavily influenced by seed choice. The std=0.220 is too high to treat as a reliable result.
5. **Crossover confirmed**: At lf<=5%, the variance between seeds becomes meaningful, consistent with v30 Phase 3c finding that pred-FT dominates mlp-rand at very low labels.
...
| GECCO | **0.822 +/- 0.008 (3s)** | 0.819 +/- 0.064 | TIED (+0.003, overlapping CI) |
