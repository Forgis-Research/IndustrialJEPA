...
ORDER=(MBA FD003 FD002 GECCO BATADAL MSL PSM)
# Note: SMD skipped too (327K test obs, ~5 hours per seed for feature
# extraction; not feasible in tonight's budget). Sepsis and PhysioNet 2012
# likewise skipped.
