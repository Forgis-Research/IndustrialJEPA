...
A Jensen-gap argument on the convex KL divergence, combined with the calibrated-posterior bound A1', the Lipschitz bound A3, and prediction error A2, yields $I(H^*; E) - I(\hat{H}; E) \leq C_p L^2 \varepsilon$, where $C_p = (2\underline{p}(1-\overline{p}))^{-1}$ is an upper bound for the tighter constant $C_\eta = (2\underline{\eta}(1-\overline{\eta}))^{-1}$ in terms of posterior bounds (\cref{ass:calibrated_posterior} in \cref{app:theory}).
