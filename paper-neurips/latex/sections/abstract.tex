...
A hybrid architecture fusing JEPA representations with handcrafted spectral features achieves $\rmse = 0.055 \pm 0.004$ on bearing remaining useful life prediction, a $75.5\%$ reduction versus time-only baselines and $20.7\%$ versus the best handcrafted-only model (5 seeds).
