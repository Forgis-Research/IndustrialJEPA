...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Hand-engineered baseline margin:} $+3.5$ RMSE over a 57-feature Ridge regressor (last-cycle values, per-sensor slope/mean/std, and sequence length; test RMSE 17.72).
...
\midrule
FD001 & 14.23$_{\pm0.4}$ & 17.81$_{\pm1.7}$ & 0.830 & 12.1 & +3.5 & 10.61 \\
