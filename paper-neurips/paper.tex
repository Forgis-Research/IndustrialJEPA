...
\plannedc{We further extend the framework to multivariate sensor inputs with physics-aware spatiotemporal masking, validate on C-MAPSS turbofan engines, and introduce a synthetic grey swan augmentation strategy for rare failure modes.}
\end{abstract}
...
\begin{enumerate}[nosep]
  ...
  \plannedc{\item Extensions to multivariate inputs with physics-aware spatiotemporal masking, validation on C-MAPSS turbofan engines, and synthetic grey swan augmentation for rare failure modes.}
\end{enumerate}
...
\plannedc{We extend the framework to multivariate sensor inputs with physics-aware spatiotemporal masking, validate on C-MAPSS turbofan engines, and introduce synthetic grey swan augmentation for rare failure modes, demonstrating generalization across sensor modalities, mechanical domains, and data regimes.}
