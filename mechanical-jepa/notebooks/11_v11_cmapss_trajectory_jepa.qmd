...
FD004 has 249 training engines, 6 operating conditions + 2 fault modes (hardest subset).
STAR supervised FD004 = 14.25. FD004 pretraining is in progress.

FD004 results: pending - pretraining running at time of writing.
...
The multi-subset extension confirms robustness: FD002 works with 6 conditions; cross-fault transfer
shows portability. These results together form a compelling case for SSL pretraining in industrial
prognostics.
