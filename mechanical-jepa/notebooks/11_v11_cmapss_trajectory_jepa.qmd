...
| Extended (200ep, patience=30) | in progress (seed 0: 14.99) | in progress (seed 0: 19.74) |

Preliminary (seed 0): extended fine-tuning does NOT help - E2E 14.99 vs standard 13.80 (worse),
and frozen 19.74 vs standard 17.81 (also worse). The 100-epoch standard fine-tuning already
converges. Extending to 200ep with patience=30 likely suffers from validation set overfitting.

Full 5-seed results will appear in RESULTS.md when complete.
...
**Cross-subset transfer (FD002 pretrain -> FD001 fine-tune)**: Frozen @ 100% = 17.50 +/- 0.83
vs FD001 in-domain frozen = 17.81. Larger pretraining corpus marginally improves frozen representations.
Full label budget E2E results and low-budget transfer results are pending completion.
