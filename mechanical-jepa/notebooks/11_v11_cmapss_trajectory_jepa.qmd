...
11. **FD004 in-domain (hardest subset)**: FD004 E2E @ 100% = 25.62+/-0.26, frozen = 29.35+/-0.61.
    E2E > frozen at all budgets (consistent direction). However, large gap to STAR (14.25) reveals
...
C-MAPSS subset). STAR supervised FD004 = 14.25. V2 JEPA pretrained from scratch on FD004 training
...
| STAR supervised FD004 | 14.25 | - | - | Paper result |

FD004 is substantially harder than FD001/FD003: E2E@100% = 25.62 vs FD001 13.80 (+11.82 RMSE).
The gap to STAR (14.25) is +11.37 RMSE. Several factors contribute:
...
1. **FD001 for primary results**: FD001 results are the main contribution. FD003 in-domain
   confirmed generalization. FD004 shows a large gap to STAR (25.62 vs 14.25) - the 6
...
conditions + 2 fault modes make FD004 the hardest subset - even STAR's supervised result (14.25)
